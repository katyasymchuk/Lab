...
14. Клоную git репозиторій на віртуальну машину та запускаю Makefile. У результаті запуску файлу запустився скрипт і тести, а файл з результами закомітився в репозиторій.
